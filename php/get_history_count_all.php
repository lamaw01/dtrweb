...
// if not put id die
if($_SERVER['REQUEST_METHOD'] == 'POST' && array_key_exists('date_from', $input)){
    ...
    WHERE tbl_logs.time_stamp BETWEEN ? AND ? AND tbl_employee.name IS NOT NULL
    ...
    try {
        ...
        $get_history_count->bindParam(1, $date_from, PDO::PARAM_STR);
        $get_history_count->bindParam(2, $date_to, PDO::PARAM_STR);
